...
@Named
@ViewScoped
public class GraficoAtividadesBean implements Serializable {
	...
	public void preRender() {
		...
		adicionarSeries("Ocorrências de Atividades");
	}

	private void adicionarSeries(String rotulo) {

		Map<Date, Long> valoresPorData = graficos.quantidadeAtividadePorData(30);
